...
{
    public class CompensacionDialog : CancelAndHelpDialog
    {
        private const string DestinationStepMsgText = "compensaciones - realiza tu consulta: LAS POLÍTICAS ESTABLECIDAS, NO CUMPLE CON CONDICIONES PARA SER TENIDO EN CUENTA EN LAS COMISIONES";

        public CompensacionDialog()
            : base(nameof(CompensacionDialog))
        {
