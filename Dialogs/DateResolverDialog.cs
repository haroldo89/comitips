...
namespace Microsoft.BotBuilderSamples.Dialogs
{
    ...
    {
        private const string PromptMsgText = "Para que fecha desea tomar esta solicitud?";
        private const string RepromptMsgText = "Formato incorrecto, por favor diligenciarlos en el siguiente formato 'yyyy-MM-dd'.";
