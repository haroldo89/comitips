...
{
    public class PenalizacionesDialog : CancelAndHelpDialog
    {
        private const string DestinationStepMsgText = "penalizaciones - realiza tu consulta: ¿COMO SABER SI SE ME ESTÁ PENALIZANDO POR DURACIÓN CONTRATO?";

        public PenalizacionesDialog()
            : base(nameof(PenalizacionesDialog))
        {
